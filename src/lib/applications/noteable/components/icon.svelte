<svg {...$$restProps} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" viewBox="0 0 512 512">
    <defs>
      <linearGradient id="linear-gradient" y1="1" x2="1" gradientUnits="objectBoundingBox">
        <stop class="text-base-100" offset="0" stop-color="currentColor"/>
        <stop class="text-base-200" offset="1" stop-color="currentColor"/>
      </linearGradient>
      <linearGradient id="linear-gradient-2" y1="1" x2="1" gradientUnits="objectBoundingBox">
        ...
        <stop class="text-accent" offset="1" stop-color="currentColor"/>
      </linearGradient>
      <linearGradient id="linear-gradient-3" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
        <stop class="text-primary" offset="0" stop-color="currentColor"/>
        <stop class="text-neutral" offset="1" stop-color="currentColor"/>
      </linearGradient>
      <linearGradient id="linear-gradient-7" y1="1" x2="1" gradientUnits="objectBoundingBox">
        <stop class="text-primary" offset="0" stop-color="currentColor"/>
        <stop class="text-secondary-content" offset="1" stop-color="currentColor"/>
      </linearGradient>
